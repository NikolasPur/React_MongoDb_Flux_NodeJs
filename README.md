# Develpment of  SPA on React, NodeJS, Express and MongoDB"
# The flux was also used

    `GET /notes` - et all content
    `POST /notes` - new spec note
    `DELETE /notes/:id` - delete

#### Used Express

[Express](http://expressjs.com/) -it's framework for Node.js, предоставляющий обширный набор функций. Он значительно упрощает маршрутизацию, использование промежуточных обработчиков (middleware), обработку запросов и отладку.
